import { ArrowUpRight, ArrowDownRight, Search, ChevronLeft, ChevronRight, MoreVertical } from "lucide-react"
        ...
        <div className="w-full bg-gray-50 font-['Roboto']">    
            <div className="p-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <RevenueChartCard quarterlyData={quarterlyData} annualData={annualData} monthlyData={monthlyData} />
